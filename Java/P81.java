                                ...
                                int[] arr = { 10, 20, 30, 40};
                                     int n = arr.length;
                                      ...
                                      System.out.println("3rd Element:"  +arr[2]);
                                              //System.out.println("Dynamic Element:"  + arr[n]);
                                   for(int i = 0 ; i<n ; i++){
                         ...
                         char[] ch = {'A' , 'B' , 'C' , 'D'  , 'E'};
                                    ...
                                    int m = ch.length;
                                      ...
                                      System.out.println("4th Element:"  +ch[3]);
                                              //System.out.println("Dynamic Element:"  + ch(m));
                                   for(int i = 0 ; i<m ; i++){
                              ...
                              String[] st = {"Ashutosh " , "Khushi" , "Nitin" , "Chandhan"};
                                      ...
                                      System.out.println("Array size:"  +o);
                                       ...
                                       System.out.println("1st Element:"  +st[0]);
                                        System.out.println("2nd  Element:"  +st[2]);
                                      System.out.println("3rd Element:"  +st[3]);
                                              //System.out.println("Dynamic Element:"  + st(o));
                                   for(int i = 0 ; i<m ; i++){
